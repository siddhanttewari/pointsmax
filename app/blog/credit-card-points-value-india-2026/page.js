        ...
        <div className="mt-10 space-y-6 text-[15px] leading-[1.85]" style={{ color: 'var(--text-s)' }}>
          ...
          <ul className="space-y-2 pl-1" style={{ listStyleType: 'none' }}>
            <li className="flex gap-2">
              ...
              <span>SmartBuy accelerated voucher rewards were <strong style={{ color: 'var(--text)' }}>capped at 3,000 points/month</strong> from July 1, 2026. The 5x rate is unchanged, but for Infinia the cap is hit at only ~₹22,500 of voucher spend (down from an effective ~₹1.12 lakh sweet spot); base points continue beyond that. A January 2026 attempt to cut the rate 5x→3x was rolled back, but this cap has stuck for now (may be temporary). Earn beyond the cap via SmartBuy flights/hotels instead.</span>
            </li>
            <li className="flex gap-2">
              <span style={{ color: 'var(--red)' }}>→</span>
