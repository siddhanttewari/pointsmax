...
const posts = [
  { slug: 'best-hsbc-credit-cards-india-2026', title: 'Best HSBC Credit Cards in India 2026: All 5 Compared (Live+ Just Got Better)', excerpt: 'While HDFC, SBI and Axis cut rewards in 2026, HSBC went the other way — most visibly with a July 2026 Live+ upgrade. All 5 HSBC cards compared (Live+, TravelOne, RuPay Cashback, Visa Platinum, RuPay Platinum), with an interactive card-by-card breakdown and a clear "which fits you" guide.', date: 'Jul 9, 2026', readTime: '12 min read', tag: 'Card Guide' },
  { slug: 'do-credit-card-points-expire-india-2026', title: 'Do Credit Card Reward Points Expire? Complete India Guide by Bank (2026)', excerpt: 'Yes — most Indian points expire in 2-3 years, and banks profit when you forget ("breakage" is pure profit for them). The full by-bank expiry table (HDFC, SBI, Axis, ICICI, Amex, IDFC First), where to check in each app, hard vs activity-based expiry, and how to never lose a point again.', date: 'Jul 8, 2026', readTime: '10 min read', tag: 'Consumer Guide' },
  { slug: 'credit-card-cibil-score-myths-india-2026', title: 'Credit Card & CIBIL Score Myths in India 2026: What Actually Helps (and Hurts)', excerpt: 'Carrying a balance does NOT help your score. Checking your CIBIL does NOT lower it. Closing an old card usually HURTS it. The 9 biggest credit score myths that cost Indians money — busted with facts, plus a free utilisation calculator.', date: 'Jul 7, 2026', readTime: '11 min read', tag: 'Consumer Guide' },
  { slug: 'how-credit-cards-work-india-2026', title: 'How a Credit Card Actually Works in India 2026 (Explained with Diagrams)', excerpt: 'The billing cycle, grace period, interest, and the money flow between you, the merchant, and the bank — explained simply with diagrams. Everything a first-time cardholder needs, and the one habit that keeps a card free instead of a debt trap.', date: 'Jul 6, 2026', readTime: '10 min read', tag: 'Beginner Guide' },
  { slug: 'credit-card-vs-upi-india-2026', title: 'Credit Card vs UPI in India 2026: Which to Use for What', excerpt: 'India is the only market where this question is genuinely interesting. When to use a credit card, when to use UPI, and how the RuPay-on-UPI hybrid lets you earn card rewards on QR payments — with a decision guide for every payment type.', date: 'Jul 6, 2026', readTime: '11 min read', tag: 'Consumer Guide' },
  ...
  { slug: 'hdfc-smartbuy-voucher-cap-july-2026', title: 'HDFC SmartBuy Voucher Cap July 2026: What Changed for Infinia & Diners', excerpt: 'From July 1, 2026, HDFC caps accelerated SmartBuy voucher rewards at 3,000 points/month. The 5X rate is unchanged — but the Infinia voucher sweet spot drops from ~₹1.12L to ~₹22,500 of monthly spend. What changed, who\'s hit, whether it\'s permanent, and what to do now.', date: 'Jul 3, 2026', readTime: '7 min read', tag: 'News · Devaluation' },
