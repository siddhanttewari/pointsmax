...
const posts = [
  { slug: 'best-credit-cards-amazon-flipkart-festival-sale-india-2026', title: 'Best Credit Cards for Amazon & Flipkart Festival Sale 2026: Maximum Savings Guide', excerpt: 'The Great Indian Festival and Big Billion Days land in late September — and the discount you see isn\'t the discount you can get. The stacking strategy (instant discount + co-branded cashback + coupons + no-cost EMI) that turns 10% off into 20%+, plus which card to use on each platform.', date: 'Jul 2, 2026', readTime: '9 min read', tag: 'Seasonal Guide' },
