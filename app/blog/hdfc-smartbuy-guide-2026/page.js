      ...
      <article className="max-w-2xl mx-auto px-5 py-12">
        ...
        <div className="mt-10 space-y-6 text-[15px] leading-[1.85]" style={{ color: 'var(--text-s)' }}>
          ...
          <div className="p-4 rounded-xl" style={{ background: '#FDF1EF', border: '1px solid #E8C5BF' }}>
            ...
            <p className="text-[13px] leading-relaxed" style={{ color: 'var(--text-s)' }}>HDFC has introduced a <strong style={{ color: 'var(--text)' }}>separate monthly cap of 3,000 accelerated Reward Points on SmartBuy Brand Voucher purchases</strong> (GyFTR/Woohoo), effective July 1, 2026. The 5X rate itself is unchanged — but this limits the voucher hack below: for Infinia, the accelerated cap is now reached at only ~₹22,500 of voucher spend per month (down from an effective ~₹1.12 lakh sweet spot). Beyond that, vouchers earn base points, not the accelerated bonus. Diners Black and Regalia Gold are capped at 3,000 accelerated voucher points too; most other cards at 1,000. The overall accelerated caps (Infinia 15,000 / Diners Black 10,000 / Regalia Gold 4,000) are unchanged and still reachable via <strong style={{ color: 'var(--text)' }}>flights and hotels booked directly on SmartBuy</strong>. The voucher hack still works up to the cap. Note: this is published for July 2026 only so far and may be a temporary experiment — HDFC rolled back a similar cut in January 2026. See the <a href="/blog/credit-card-devaluation-tracker-india-2026" style={{ color: 'var(--gold, #B8953E)', textDecoration: 'underline' }}>devaluation tracker</a> for the latest.</p>
          </div>
