...
const blogJsonLd = {
  ...
  review: {
    ...
    reviewBody: 'HDFC Infinia remains the most valuable credit card in India in 2026 for travel, offering ₹1 per reward point on SmartBuy flights and hotels and 22 airline/hotel transfer partners. However, a July 1, 2026 change capped accelerated SmartBuy voucher rewards at 3,000 points/month: the 5X rate is unchanged, but the voucher sweet spot dropped to about ₹22,500 of monthly spend (from roughly ₹1.12 lakh), with base points continuing beyond that. New monthly caps plus an ₹18L annual spend retention requirement make it less of a set-and-forget card than before. The voucher cap may be a temporary experiment.',
  },
}
      ...
      <article className="max-w-2xl mx-auto px-5 py-12">
        ...
        <div className="mt-10 space-y-6 text-[15px] leading-[1.85]" style={{ color: 'var(--text-s)' }}>
          ...
          <div className="space-y-2">
            <Warn title="July 2026: SmartBuy accelerated voucher rewards capped at 3,000 points/month">HDFC first tried cutting Gyftr voucher rewards from 5x to 3x in January 2026 and rolled it back after backlash. Then, effective July 1, 2026, it introduced a separate monthly cap of 3,000 accelerated Reward Points on SmartBuy brand vouchers. The 5x rate itself is unchanged — but for Infinia the cap is reached at only ~₹22,500 of voucher spend per month, down from an effective sweet spot of roughly ₹1.12 lakh. Beyond that, vouchers earn the base rate (5 pts/₹150), not the accelerated bonus. The overall 15,000 accelerated cap is unchanged and still reachable via SmartBuy flights and hotels. This is published for July 2026 only so far and may be a temporary experiment — but it materially changes the everyday-earning math for heavy voucher buyers.</Warn>
