    ...
    <div className="min-h-screen">
      ...
      <article className="max-w-2xl mx-auto px-5 py-12">
        ...
        <div className="mt-10 space-y-6 text-[15px] leading-[1.85]" style={{ color: 'var(--text-s)' }}>
          ...
          <p>See how Marriott earning compares to flexible points for your spend with the <a href="/" style={{ color: 'var(--gold, #B8953E)', textDecoration: 'underline' }}>PointsMax calculator</a>, and for the broader redemption framework read our guide on <a href="/blog/how-to-redeem-credit-card-points-india-2026" style={{ color: 'var(--gold, #B8953E)', textDecoration: 'underline' }}>how to redeem credit card points for maximum value</a>. For airline alternatives, see the <a href="/blog/best-krisflyer-routes-india-2026" style={{ color: 'var(--gold, #B8953E)', textDecoration: 'underline' }}>KrisFlyer routes guide</a>.</p>
