    ...
    <div className="min-h-screen">
      ...
      <article className="max-w-2xl mx-auto px-5 py-12">
        ...
        <div className="mt-10 space-y-6 text-[15px] leading-[1.85]" style={{ color: 'var(--text-s)' }}>
          ...
          <p>To see all transfer partners available for your specific card with current ratios, check the <a href="/transfers" style={{ color: 'var(--gold)', textDecoration: 'underline' }}>Transfer Partners directory</a> or run your points through the <a href="/" style={{ color: 'var(--gold)', textDecoration: 'underline' }}>PointsMax calculator</a>.</p>
