  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-2xl mx-auto px-5 py-16">
        ...
        <h1 style={{ fontFamily: 'Playfair Display, serif', fontWeight: 700, fontSize: '28px', color: 'var(--text)', letterSpacing: '-0.02em' }}>About PointsMax</h1>
        ...
        <div className="mt-8 space-y-5 text-[14px] leading-[1.8]" style={{ color: 'var(--text-s)' }}>
          ...
          <h2 className="text-[16px] font-semibold pt-4" style={{ color: 'var(--text)' }}>What Makes Us Different</h2>
          <p>
          ...
          <h2 className="text-[16px] font-semibold pt-4" style={{ color: 'var(--text)' }}>Independence</h2>
          <p>
          ...
          <h2 className="text-[16px] font-semibold pt-4" style={{ color: 'var(--text)' }}>Disclaimer</h2>
          <p>
